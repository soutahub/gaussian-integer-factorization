    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 py-12 px-4">
      ...
      >
        <div className="flex justify-end mb-4 space-x-4">
          <Link href="/" locale="en" className="text-gray-600 hover:text-gray-900">{t('language.en')}</Link>
          <Link href="/" locale="ja" className="text-gray-600 hover:text-gray-900">{t('language.ja')}</Link>
        </div>
